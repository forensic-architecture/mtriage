...
class TestAnalyser(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(f"{self.FOLDER}/analyser-logs.txt", self.emptyAnalyser.ANALYSER_LOGS)
    ...
    def test_get_derived_folder(self):
        ...
        self.assertEqual(derived_folder, f"{self.FOLDER}/sel1/{Analyser.DERIVED_EXT}/{self.NAME}")
    ...
    def test_run(self):
        ...
        self.assertTrue(os.path.exists(f"{self.FOLDER}/sel1/{Analyser.DERIVED_EXT}/{self.NAME}/el1"))
        self.assertTrue(os.path.exists(f"{self.FOLDER}/sel1/{Analyser.DERIVED_EXT}/{self.NAME}/el2"))
        self.assertTrue(os.path.exists(f"{self.FOLDER}/sel1/{Analyser.DERIVED_EXT}/{self.NAME}/el3"))
        self.assertTrue(os.path.exists(f"{self.FOLDER}/sel2/{Analyser.DERIVED_EXT}/{self.NAME}/el4"))
        self.assertTrue(os.path.exists(f"{self.FOLDER}/sel2/{Analyser.DERIVED_EXT}/{self.NAME}/el5"))
        self.assertTrue(os.path.exists(f"{self.FOLDER}/sel2/{Analyser.DERIVED_EXT}/{self.NAME}/el6"))
