class SelectorNotFoundError(Exception):
    ...
    def __init__(self, selector):
        super().__init__(f"""Could not find a valid selector named '{selector}'. Ensure that you have a folder named
...
class AnalyserNotFoundError(Exception):
    ...
    def __init__(self, analyser):
        super().__init__(f"""Could not find a valid analyser named '{analyser}'. Ensure that you have a folder named
